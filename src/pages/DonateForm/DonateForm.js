  ...
  return (
    <main className="donateform__section" ref={donateFormTopRef}>
      ...
      <p className="donateform__text1">
        To make a donation the Slocan and Area Trail Society, please first send
        your donation via etransfer from your institution to:
        slocanandareatrailsociety@gmail.com
      </p>
      <p className="donateform__text2">
        Once your transfer is sent, please fill out the form below and include
        the 'Additional Details' in the message section. Please be sure to
        indicate if you would like a receipt and we will issue one via the means
        you specify. We will confirm with you once we receive your donation (may
        take up to a week).
      </p>
      <p className="donateform__text3">
        Please copy and paste these details into the message section and
      ...
      <ul className="donateform__addDetails">
        ...
        <li className="donateform__item">Receipt Method - email/physical:</li>
